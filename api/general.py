...
@reg.post("/register",description="用户注册")
...
@manager.post("/login", response_model=UserResponse, description="用户登录")
...
@manager.get("/user_info/{user_id}", response_model=UserResponse, description="获取用户信息")
...
@manager.put("/change_password", description="修改密码")
